...
//                    binding.tvDirectionValue.text = define.arahAngin(data?.windDr.toString())
                    val windDir = define.arahAngin(data?.windDr.toString())
                    binding.tvDirectionValue.setText(windDir)
//                    binding.todayCondition.text = define.kondisiCuaca(data?.weatherCond.toString())
                    val weatherCond = define.kondisiCuaca(data?.weatherCond.toString())
                    binding.todayCondition.setText(weatherCond)
